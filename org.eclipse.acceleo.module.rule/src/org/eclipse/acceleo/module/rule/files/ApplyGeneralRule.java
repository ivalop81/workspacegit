...
/**
 * Entry point of the 'ApplyGeneralRule' generation module.
 *
 * @generated
 */
public class ApplyGeneralRule extends AbstractAcceleoGenerator {
	/**
	 * The name of the module.
	 *
	 * @generated
	 */
	public static final String MODULE_FILE_NAME = "applyGeneralRule";
	 ...
	 * @generated
	 */
	public static final String[] TEMPLATE_NAMES = { "applyGeneralRule", };
	 ...
	 * @generated
	 */
	public ApplyGeneralRule(URI modelURI, File targetFolder,
	 ...
	 * @generated
	 */
	public ApplyGeneralRule(EObject model, File targetFolder,
			List<? extends Object> arguments) throws IOException {
    ...
    try {
      if (args.length < 2) {
        ...
        ApplyGeneralRule generator = new ApplyGeneralRule(modelURI, folder, arguments);
