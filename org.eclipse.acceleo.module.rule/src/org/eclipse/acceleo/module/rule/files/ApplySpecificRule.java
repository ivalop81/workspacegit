...
/**
 * Entry point of the 'ApplySpecificRule' generation module.
 *
 * @generated
 */
public class ApplySpecificRule extends AbstractAcceleoGenerator {
	/**
	 * The name of the module.
	 *
	 * @generated
	 */
	public static final String MODULE_FILE_NAME = "applySpecificRule";
	 ...
	 * @generated
	 */
	public static final String[] TEMPLATE_NAMES = { "applySpecificRule", };
	 ...
	 * @generated
	 */
	public ApplySpecificRule(URI modelURI, File targetFolder,
	 ...
	 * @generated
	 */
	public ApplySpecificRule(EObject model, File targetFolder,
			List<? extends Object> arguments) throws IOException {
    ...
    try {
      if (args.length < 2) {
        ...
        ApplySpecificRule generator = new ApplySpecificRule(modelURI, folder, arguments);
