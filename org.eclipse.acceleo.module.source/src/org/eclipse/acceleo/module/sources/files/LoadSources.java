...
/**
 * Entry point of the 'LoadSources' generation module.
 *
 * @generated
 */
public class LoadSources extends AbstractAcceleoGenerator {
	/**
	 * The name of the module.
	 *
	 * @generated
	 */
	public static final String MODULE_FILE_NAME = "loadSources";
	 ...
	 * @generated
	 */
	public static final String[] TEMPLATE_NAMES = { "loadSources", };
	 ...
	 * @generated
	 */
	public LoadSources(URI modelURI, File targetFolder,
	 ...
	 * @generated
	 */
	public LoadSources(EObject model, File targetFolder,
			List<? extends Object> arguments) throws IOException {
    ...
    try {
      if (args.length < 2) {
        ...
        LoadSources generator = new LoadSources(modelURI, folder, arguments);
