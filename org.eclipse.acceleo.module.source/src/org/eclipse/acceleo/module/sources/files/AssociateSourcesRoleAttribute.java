...
/**
 * Entry point of the 'RoleAttributeSources' generation module.
 *
 * @generated
 */
public class AssociateSourcesRoleAttribute extends AbstractAcceleoGenerator {
	/**
	 * The name of the module.
	 *
	 * @generated
	 */
	public static final String MODULE_FILE_NAME = "associateSourcesRoleAttribute";
	 ...
	 * @generated
	 */
	public static final String[] TEMPLATE_NAMES = { "associateSourcesRoleAttribute", };
	 ...
	 * @generated
	 */
	public AssociateSourcesRoleAttribute() {
	 ...
	 * @generated
	 */
	public AssociateSourcesRoleAttribute(URI modelURI, File targetFolder,
	 ...
	 * @generated
	 */
	public AssociateSourcesRoleAttribute(EObject model, File targetFolder,
			List<? extends Object> arguments) throws IOException {
	...
	public static void main(String[] args) {
		try {
			if (args.length < 2) {
				...
				AssociateSourcesRoleAttribute generator = new AssociateSourcesRoleAttribute(modelURI, folder, arguments);
