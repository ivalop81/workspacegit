...
/**
 * Entry point of the 'GenerateTable' generation module.
 *
 * @generated
 */
public class GenerateTableSource extends AbstractAcceleoGenerator {
	/**
	 * The name of the module.
	 *
	 * @generated
	 */
	public static final String MODULE_FILE_NAME = "generateTableSource";
	 ...
	 * @generated
	 */
	public static final String[] TEMPLATE_NAMES = { "generateTableSource", };
	 ...
	 * @generated
	 */
	public GenerateTableSource(URI modelURI, File targetFolder,
	 ...
	 * @generated
	 */
	public GenerateTableSource(EObject model, File targetFolder,
			List<? extends Object> arguments) throws IOException {
    ...
    try {
      if (args.length < 2) {
        ...
        GenerateTableSource generator = new GenerateTableSource(modelURI, folder, arguments);
